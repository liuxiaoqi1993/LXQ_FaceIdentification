...
def grdetect(array, verbose = False):
    ...
    if verbose:
        _draw_contours(copy, contours    ,-1, _COLOR_RED  , 0)#轮廓
        _draw_contours(copy, [largecont] , 0, _COLOR_GREEN, 0)
        _draw_contours(copy, [convexHull], 0, _COLOR_RED, 0)
        #cv2.polylines(copy,[convexHull], True, (0, 255, 0), 2)
